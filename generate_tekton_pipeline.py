...
def generate_without_RAG(jenkinsfile_content: str) -> str:
    prompt = NO_RAG_PROMPT_TEMPLATE.format(jenkinsfile_content_placeholder = jenkinsfile_content)
...
def build_prompt_with_rag(jenkinsfile_content: str, relevant_docs: list) -> str:
    ...
    prompt = RAG_PROMPT_TEMPLATE.format(
        combined_context_placeholder=combined_context,
